...
export const Swatches = forwardRef(function Swatches({ className, role, label, children, ...rest }, ref) {
    return (_jsx("div", { ref: ref, className: cx(cls.swatches, className), role: role ?? "group", "aria-label": label, ...rest, children: children }));
});
